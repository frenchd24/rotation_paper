...
def main():
    # open the data files
    model_directory = '/Users/frenchd/Research/rotation_paper_data/rotation_models_v4/NGC3633/RX_J1121.2+0326/'
    models_filename = '{0}/NGC3633-RX_J1121.2+0326_model_NFWTrue.p'.format(model_directory)

    NFW_model_file = open(models_filename,'r')
...
#     movie_directory = '/Users/frenchd/Research/inclination/git_inclination/thesis/DMF_thesis/NGC3633_movie/'
    ...
    save_directory = '/Users/frenchd/Research/rotation_paper_data/figures/'
...
#         legend(scatterpoints=1,prop={'size':12},loc='upper left',fancybox=True)
        ...
        majorFormatter = FormatStrFormatter(r'$\rm %d$')
        minorLocator   = MultipleLocator(x_ticks/5)
        ax.xaxis.set_major_locator(majorLocator)
        ax.xaxis.set_major_formatter(majorFormatter)
        ax.xaxis.set_minor_locator(minorLocator)
        ...
        majorFormatter = FormatStrFormatter(r'$\rm %d$')
        minorLocator   = MultipleLocator(y_ticks/5)
        ax.yaxis.set_major_locator(majorLocator)
        ax.yaxis.set_major_formatter(majorFormatter)
        ax.yaxis.set_minor_locator(minorLocator)
