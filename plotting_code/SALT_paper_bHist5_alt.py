...
$Id: SALT_paper_bHist4.py, v4.0 10/26/18

Plots histograms of b-parameters

v3: Some other updates (04/30/18)

v3.1: Matched the SALT_paper_map2.py error and rotation direction part, which was more 
robust (07/15/18)

v4: Updated for final (hopefully submitted) version (10/26/18)

v5: Updated for referee report (11/6/19)
...
#     Lstar_range = [0.0, 0.8]
    ...
    # include a +/-10 km/s error on rotation velocity?
