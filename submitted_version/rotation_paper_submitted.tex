...
\author[0000-0003-3681-0016]{David M. French}
...
\author[0000-0002-0507-7096]{Bart P. Wakker}
\affil{Department of Astronomy, University of Wisconsin, Madison, WI 53706, USA}

%\correspondingauthor{David M. French}
%\email{frenchd24@gmail.com}
...
Finally, we consider the Doppler $b$-parameters of our absorber sample. Figure \ref{b_hist} shows the distribution of $b$-parameters for all velocity-constrained Ly$\alpha$ absorbers ($\lvert \Delta v \rvert \leq v_{\rm rot}$). In the top panel of Figure \ref{b_hist} we separate them into co-rotating and anti-rotating subsets, in the middle panel we do the same but only for $\rho \leq 1 R_{\rm vir}$, and on the bottom we separate based on absorbers near \Lstar $\leq 0.6$ and \Lstar $ > 0.6$ galaxies. Interestingly, we find that \emph{lower} $b$-parameter absorbers tend to be both anti-rotating and found near \Lstar $> 0.6$ galaxies. As previously discussed however, the picture described by the simulations of \cite{stewart2011b} and others describes a scenario where co-rotating gas is predominately the product of cold-mode accretion. Hotter, outflowing gas would likely carry angular momentum from the disk with it, but this would be quickly lost as the outflows expand into the halo and result in negligible observable rotation signature. 
...
\centering
  ...
  \caption{\small{\textbf{Top:} The distributions of Doppler $b$-parameters for all Ly$\alpha$ absorbers with $\lvert \Delta v \rvert \leq v_{\rm rot}$. The co-rotating versus anti-rotating designation here is based on NFW results. In the middle we do the same but only for $\rho \leq 1 R_{vir}$, and on the bottom we separate based on absorbers near \Lstar $\leq 0.6$ (blue) and \Lstar $ > 0.6$ (red-hatched) galaxies.  \textbf{Bottom:} The Doppler $b$-parameters of each absorber as a function of $\Delta v$, split into co-rotating (blue diamonds) and anti-rotating (red crosses). The data point for the NGC3067-3C232 LLS ($b = 245.2 \pm 25.9,  ~\Delta v = -68.0 \pm 11$ \kms, co-rotating) is not shown in order to highlight the majority distribution in greater detail.}}
\label{b_vs_dv2}
\end{figure}
...
$\lvert \Delta v \rvert \leq v_{\rm rot}$ 	&						&						&					&						&						&						&					\\
\hline
...
3. Two thirds of all $\rm Ly\alpha$ absorbers are found with velocity separations less than or equal to the nearby galaxy rotation velocity ($\lvert \Delta v \rvert \leq v_{\rm rot}$). This includes systems with multiple galaxies and undoubtedly complex velocity fields. Restricting this study to only isolated galaxy-QSO systems would likely result in an even higher fraction.
...
5. Co-rotating absorbers (when chosen from the sample restricted to $\lvert \Delta v \rvert \leq v_{\rm rot}$) occupy a wide range in Doppler $b$-parameter, while anti-rotators have mostly $b \leq 50$ \kms. A remarkably similar split is found for absorbers near $L \leq 0.6 $\Lstar~ vs $L > 0.6$\Lstar~ galaxies. This could add further evidence for our proposed cold-mode accretion explanation if these enhanced $b$-parameters are caused by the blending of multiple absorption components close in velocity space within a filament.
...
%  \subfigure[]{\includegraphics[width=.54\linewidth]{CGCG039-137_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_CGCG039-137}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{CGCG039-137-rotation_curve_nice4.pdf}}{\label{rotationcurve_CGCG039-137}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{CGCG039-137_FindingChart_final.pdf}\label{finderchart_CGCG039-137}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{RFGC3781_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_ESO343-G014}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{ESO343-G014-rotation_curve_nice4.pdf}}{\label{rotationcurve_ESO343-G014}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{ESO343-G014_FindingChart_final.pdf}\label{finderchart_ESO343-G014}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{IC5325_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_IC5325}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{IC5325-rotation_curve_nice4.pdf}}{\label{rotationcurve_IC5325}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{IC5325_FindingChart_final.pdf}\label{finderchart_IC5325}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{MCG-03-58-009_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_MCG-03-58-009}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{MCG-03-58-009-rotation_curve_nice4.pdf}}{\label{rotationcurve_MCG-03-58-009}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{MCG-03-58-009_FindingChart_final.pdf}\label{finderchart_MCG-03-58-009}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC1566_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC1566}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC1566-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC1566}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC1566_FindingChart_final.pdf}\label{finderchart_NGC1566}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC3513_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC3513}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC3513-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC3513}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC3513_FindingChart_final.pdf}\label{finderchart_NGC3513}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC3633_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC3633}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC3633-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC3633}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC3633_FindingChart_final.pdf}\label{finderchart_NGC3633}}
...
\begin{figure}[h]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC4536_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC4536}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC4536-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC4536}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC4536_FindingChart_final.pdf}\label{finderchart_NGC4536}}
...
\begin{figure}[ht!]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC4939_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC4939}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC4939-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC4939}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC4939_FindingChart_final.pdf}\label{finderchart_NGC4939}}
...
\begin{figure}[ht!]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC5364_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC5364}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC5364-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC5364}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC5364_FindingChart_final.pdf}\label{finderchart_NGC5364}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC5786_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_NGC5786}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{NGC5786-rotation_curve_nice4.pdf}}{\label{rotationcurve_NGC5786}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{NGC5786_FindingChart_final.pdf}\label{finderchart_NGC5786}}
...
\begin{figure}[ht]
\centering
%  \subfigure[]{\includegraphics[width=0.5\linewidth]{UGC09760_2_rotation_curve_xphys_helio_vobs_vrotObs_new4.pdf}}{\label{rotationcurve_UGC09760}}
  \subfigure[]{\includegraphics[width=0.5\linewidth]{UGC09760-rotation_curve_nice4.pdf}}{\label{rotationcurve_UGC09760}}
  \subfigure[]{\includegraphics[width=0.49\linewidth]{UGC09760_FindingChart_final.pdf}\label{finderchart_UGC09760}}
